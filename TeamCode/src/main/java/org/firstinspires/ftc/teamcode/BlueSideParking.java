...
@Config
@Autonomous(name = "Blue Parking: Observation Side", group = "Autonomous")
public class BlueSideParking extends LinearOpMode {
    ...
    public void runOpMode() {
        Pose2d beginPose = new Pose2d(-11.94, 64.27, Math.toRadians(270.00));
